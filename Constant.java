...
class Constant
{
    ...
    public static void getP(double [][]finalpb)
    {
...
//        double tempP4 = (double)1/5 + (double)4/5*(Math.pow(Math.E, -5*beta*t));
        ...
        p[0][0] = finalpb[0][0]; p[0][1] = finalpb[0][1]; p[0][2] = finalpb[4][2]; p[0][3] = finalpb[0][3]; p[0][4] = finalpb[0][4];
        p[1][0] = finalpb[1][0]; p[1][1] = finalpb[1][1]; p[1][2] = finalpb[4][2]; p[1][3] = finalpb[1][3]; p[1][4] = finalpb[1][4];
        p[2][0] = finalpb[2][0]; p[2][1] = finalpb[2][1]; p[2][2] = finalpb[4][2]; p[2][3] = finalpb[2][3]; p[2][4] = finalpb[2][4];
        p[3][0] = finalpb[3][0]; p[3][1] = finalpb[3][1]; p[3][2] = finalpb[4][2]; p[3][3] = finalpb[3][3]; p[3][4] = finalpb[3][4];
        p[4][0] = finalpb[4][0]; p[4][1] = finalpb[4][1]; p[4][2] = finalpb[4][2]; p[4][3] = finalpb[4][3]; p[4][4] = finalpb[4][4];
    }
